...
function logTrackerMessageId(kind, action, { chatId, messageId, envName }) {
	console.info('[telegram tracker message]', {
		kind,
		action,
		chatId,
...
export async function updateScheduleMessage() {
	...
	if (!targetMessageId) {
		...
		logTrackerMessageId('schedule', 'created', {
			chatId: WORK_CHAT_ID,
	...
	try {
		...
		logTrackerMessageId('schedule', 'updated', {
			chatId: WORK_CHAT_ID,
...
export async function updateIncompleteCompletionMessage() {
	...
	if (!targetMessageId) {
		...
		logTrackerMessageId('incomplete_completions', 'created', {
			chatId: WORK_CHAT_ID,
			messageId: sent?.message_id,
	...
	try {
		...
		logTrackerMessageId('incomplete_completions', 'updated', {
			chatId: WORK_CHAT_ID,
			messageId: targetMessageId,
			envName: 'TELEGRAM_INCOMPLETE_COMPLETIONS_MESSAGE_ID',
		})
...
export async function updateSmsTrackerMessage() {
	...
	if (!targetMessageId) {
		...
		logTrackerMessageId('sms_forms', 'created', {
	...
	try {
		...
		logTrackerMessageId('sms_forms', 'updated', {
			chatId: LEADS_CHAT_ID,
			messageId: targetMessageId,
			envName: 'TELEGRAM_SMS_TRACKER_MESSAGE_ID',
		})
